...
const url =
  ...
  `mongodb+srv://${process.env.MONGO_USERNAME}:${process.env.MONGO_PASSWORD}@cluster0.8i1rzql.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`; // updated connection url
